...
unset($__errorArgs, $__bag); ?>" required autofocus value="<?php echo e(old ('name')); ?>" id="floatingInput" placeholder="Username">
...
unset($__errorArgs, $__bag); ?>
        ...
        <input type="password" name="repassword" class="border p-4 <?php $__errorArgs = ['repassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="floatingPassword" placeholder="Re-enter password">
